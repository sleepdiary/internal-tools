...
# See check-prerelease-build-system.sh for how to do this
# (might want to make a library for both scripts to use?)
...
then
    ...
    echo "2. but only merge the PR for the internal-tools repository"
